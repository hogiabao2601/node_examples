...
var login_page = {
  url: 'https://isacombank.com.vn/corp/AuthenticationController?FORMSGROUP_ID__=AuthenticationFG&__START_TRAN_FLAG__=Y&__FG_BUTTONS__=LOAD&ACTION.LOAD=Y&AuthenticationFG.LOGIN_FLAG=1&BANK_ID=303&AuthenticationFG.PREFERRED_LANGUAGE=003',
};
...
request.get(login_page, (err, res, body) => {
  if (err) {
    ...
    var key = $('input[name="__JS_ENCRYPT_KEY__"]').val();
    var loginUrl = "https://www.isacombank.com.vn/corp/" + $('form[name="AuthenticationFG"]').attr('action');
    var passwordElement = {};
    getPublicKeyFromServer((publicKey) => {
      var originalValue = 'abc';
      encrypt(
        ...
        function (encrypted, passwordElement) {
          ...
          passwordElement.maxlength = encrypted.length;
    ...
    line.question("Nhập captcha:  ", function (captcha) {
      var bwayparam = loginUrl.split('bwayparam=')[1];
      ...
      var param = {
        ...
        form: {
          ...
          "AuthenticationFG.ACCESS_CODE": passwordElement.value,
          MIN_LENGTH_OF_PASSWORD: 6,
          PWD_SPECIAL_CHAR_MANDATORY: "N",
          PWDDIGITMAND: "N",
          "IMAGE_PATH": "L003/consumer/images",
          "AuthenticationFG.VERIFICATION_CODE": captcha,
          "Action.VALIDATE_CREDENTIALS": "Đăng nhập",
          "AuthenticationFG.MENU_ID": 0,
          "FG_BUTTONS__": "VALIDATE_CREDENTIALS,STU_VALIDATE_CREDENTIALS,VALIDATE_CREDENTIALS_DIG_CERT,BACK,CLEAR_VALUES",
          "AuthenticationFG.IS_FIRST_AUTHENTICATION": "Y",
          "AuthenticationFG.PREFERRED_LANGUAGE1": "001",
          "FORMSGROUP_ID__": "AuthenticationFG",
          "AuthenticationFG.REPORTTITLE": "AuthenticationScreen",
          "RIA_TARGETS": null,
          "JS_ENABLED_FLAG": "Y",
          "Requestid": 1,
          "__JS_ENCRYPT_FLAG__": "N",
          "__JS_ENCRYPT_KEY__": "key"
        }
      }
